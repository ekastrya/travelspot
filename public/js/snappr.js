...
(function() {
    ...
    var webflowBackgroundVideo = __commonjs(function(module) {
        ...
        Webflow.define('backgroundVideo', module.exports = function($) {
            ...
            function ready() {
                ...
                var backgroundVideoNodes = $(document).find('.snappr-w-background-video').not('.snappr-w-background-video-atom');
    ...
    var webflowBrand = __commonjs(function(module) {
        ...
        Webflow.define('brand', module.exports = function($) {
            ...
            var $html = $('html');
            var $body = $('body');
            var namespace = '.snappr-w-webflow-badge';
            ...
            function createBadge() {
                var $brand = $('<a class="snappr-w-webflow-badge"></a>')
    ...
    var webflowForms = __commonjs(function(module) {
        ...
        Webflow.define('forms', module.exports = function($, _) {
            ...
            function build(i, el) {
                ...
                reset(data);
                var wrap = $el.closest('div.snappr-w-form');
                data.done = wrap.find('> .snappr-w-form-done');
                data.fail = wrap.find('> .snappr-w-form-fail');
    ...
    var webflowIx = __commonjs(function(module) {
        ...
        Webflow.define('ix', module.exports = function($, _) {
            ...
            var components = {
                tabs: '.snappr-w-tab-link, .snappr-w-tab-pane',
                dropdown: '.snappr-w-dropdown',
                slider: '.snappr-w-slide',
                navbar: '.snappr-w-nav'
            };
    ...
    var webflowLightbox = __commonjs(function(module) {
        ...
        function createLightbox(window, document, $) {
            ...
            (function() {
                ...
                function refresh() {
                    ...
                    var content =
                        '.snappr-w-lightbox-content, .snappr-w-lightbox-view, .snappr-w-lightbox-view:before {' +
                        'height:' + vh + 'px' +
                        '}' +
                        '.snappr-w-lightbox-view {' +
                        'width:' + vw + 'px' +
                        '}' +
                        '.snappr-w-lightbox-group, .snappr-w-lightbox-group .snappr-w-lightbox-view, .snappr-w-lightbox-group .snappr-w-lightbox-view:before {' +
                        'height:' + (0.86 * vh) + 'px' +
                        '}' +
                        '.snappr-w-lightbox-image {' +
                        'max-width:' + vw + 'px;' +
                        'max-height:' + vh + 'px' +
                        '}' +
                        '.snappr-w-lightbox-group .snappr-w-lightbox-image {' +
                        'max-height:' + (0.86 * vh) + 'px' +
                        '}' +
                        '.snappr-w-lightbox-strip {' +
                        'padding: 0 ' + (0.01 * vh) + 'px' +
                        '}' +
                        '.snappr-w-lightbox-item {' +
                        'width:' + (0.1 * vh) + 'px;' +
                        'padding:' + (0.02 * vh) + 'px ' + (0.01 * vh) + 'px' +
                        '}' +
                        '.snappr-w-lightbox-thumbnail {' +
                        'height:' + (0.1 * vh) + 'px' +
                        '}' +
        ...
        Webflow.define('lightbox', module.exports = function($) {
            ...
            var designer;
            var inApp = Webflow.env();
            var namespace = '.snappr-w-lightbox';
            var groups;
            ...
            function configure(data) {
                var json = data.el.children('.snappr-w-json').html();
                var groupName;
                var groupItems;
    ...
    var webflowNavbar = __commonjs(function(module) {
        ...
        Webflow.define('navbar', module.exports = function($, _) {
            ...
            var designer;
            var inApp = Webflow.env();
            var overlay = '<div class="snappr-w-nav-overlay" data-wf-ignore />';
            var namespace = '.snappr-w-nav';
            ...
            function build(i, el) {
                ...
                data.menu = $el.find('.snappr-w-nav-menu');
                data.links = data.menu.find('.snappr-w-nav-link');
                data.dropdowns = data.menu.find('.snappr-w-dropdown');
                data.button = $el.find('.snappr-w-nav-button');
                data.container = $el.find('.snappr-w-container');
            ...
            function outside(data) {
                ...
                return _.debounce(function(evt) {
                    if (!data.open) return;
                    var menu = $(evt.target).closest('.snappr-w-nav-menu');
    ...
    var webflowScroll = __commonjs(function(module) {
        ...
        Webflow.define('scroll', module.exports = function($) {
            ...
            function findEl(hash, e) {
                ...
                var rootTag = Webflow.env('editor') ? '.snappr-w-editor-body' : 'body';
                var header = $('header, ' + rootTag + ' > .header, ' + rootTag + ' > .snappr-w-nav:not([data-no-scroll])');
    ...
    var webflowSlider = __commonjs(function(module) {
        ...
        Webflow.define('slider', module.exports = function($, _) {
            ...
            var designer;
            var inApp = Webflow.env();
            var namespace = '.snappr-w-slider';
            var dot = '<div class="snappr-w-slider-dot" data-wf-ignore />';
            var ix = IXEvents.triggers;
            var fallback;
            var inRedraw;
            ...
            function build(i, el) {
                ...
                data.mask = $el.children('.snappr-w-slider-mask');
                data.left = $el.children('.snappr-w-slider-arrow-left');
                data.right = $el.children('.snappr-w-slider-arrow-right');
                data.nav = $el.children('.snappr-w-slider-nav');
                data.slides = data.mask.children('.snappr-w-slide');
    ...
    var webflowTabs = __commonjs(function(module) {
        ...
        Webflow.define('tabs', module.exports = function($) {
            ...
            function build(i, el) {
                ...
                data.current = null;
                data.menu = $el.children('.snappr-w-tab-menu');
                data.links = data.menu.children('.snappr-w-tab-link');
                data.content = $el.children('.snappr-w-tab-content');
                data.panes = data.content.children('.snappr-w-tab-pane');
...
Webflow.require('ix').init([{
    ...
    {
        "slug": "new-portfolio-overlay-hide",
        "name": "NEW Portfolio Overlay Hide",
        "value": {
            "style": {},
            "triggers": [{
                "type": "hover",
    ...
    {
        "slug": "shoot-type-hover",
        "name": "Shoot Type Hover",
        "value": {
            "style": {
                "opacity": 0
            },
    ...
    {
        "slug": "icon-to-white-on-hover",
        "name": "Icon to White on Hover",
        "value": {
            "style": {},
            "triggers": [{
                "type": "tabs",
                "selector": ".new-hiw-tab-button-image-hover",
                "descend": true,
                "loopA": true,
                "stepsA": [{
                    "wait": 500,
                ...
                "type": "tabs",
                "selector": ".new-hiw-tab-button-image",
                "descend": true,
                "loopA": true,
                "stepsA": [{
                    "wait": 500,
    ...
    {
        "slug": "show-more-specialties",
        "name": "Show More Specialties",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
                "selector": ".new-shoot-types-group-2",
                "preserve3d": true,
                "stepsA": [{
                    "wait": 0,
                    "display": "block"
    ...
    {
        "slug": "new-collage-appear",
        "name": "New Collage Appear",
        "value": {
            "style": {
                "opacity": 0,
                "x": "500px",
            ...
            "triggers": [{
                ...
                "stepsA": [{
                    "opacity": 1,
                    "transition": "transform 1000ms ease-out 0ms, opacity 1500ms ease 0ms",
                    "x": "0px",
                    "y": "0px",
                    "z": "0px"
                }],
    ...
    {
        "slug": "new-hiw-tab-appear",
        "name": "New HIW Tab Appear",
        "value": {
            "style": {
                "opacity": 0,
                "scaleX": 0.9,
    ...
    {
        "slug": "analyzer-overlay-appear",
        "name": "Analyzer Overlay Appear",
        "value": {
            "style": {
                "height": "0px"
            },
            "triggers": [{
                ...
                "stepsA": [{
                    "opacity": 1,
                    "transition": "opacity 4000ms ease 0"
                }, {
                    "height": "300px",
                    "transition": "height 1000ms ease 0, width 200 ease 0"
                }, {
                    "height": "0px",
    ...
    {
        "slug": "analyzer-text-throb",
        "name": "Analyzer Text Throb",
        "value": {
            "style": {
                "opacity": 0
            },
    ...
    {
        "slug": "analyzer-image-appear",
        "name": "Analyzer Image Appear",
        "value": {
            "style": {
                "height": "0px"
            },
            "triggers": [{
                ...
                "stepsA": [{
                    ...
                    "height": "300px",
                    "transition": "height 1000ms ease 0, width 1000ms ease 0"
                }],
                "stepsB": []
            }]
        }
    ...
    {
        "slug": "new-show-answer",
        "name": "New Show Answer",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
                "selector": ".new-faq-answer",
                "siblings": true,
                "stepsA": [{
                    "display": "block",
                    "height": "auto",
    ...
    {
        "slug": "show-contact-modal",
        "name": "Show Contact Modal",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
                "selector": ".new-modal-wrapper",
                "preserve3d": true,
                "stepsA": [{
                    "display": "block"
                }, {
    ...
    {
        "slug": "new-display-none",
        "name": "New Display None",
        "value": {
            "style": {
                "display": "none"
            },
    ...
    {
        "slug": "new-modal-initial",
        "name": "New Modal Initial",
        "value": {
            "style": {
                "opacity": 0,
                "scaleX": 0.9,
    ...
    {
        "slug": "show-feature-request-form",
        "name": "Show Feature Request Form",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
                "selector": ".new-partner-feature-request-form",
                "stepsA": [{
                    "opacity": 1,
                    "height": "auto",
                    "transition": "height 500ms ease 0, opacity 200 ease 0"
                }],
                "stepsB": []
            }, {
                "type": "click",
    ...
    {
        "slug": "make-another-booking",
        "name": "Make another booking",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
                ...
                "type": "click",
                "selector": ".new-partner-success-box",
                "stepsA": [{
                    "display": "none"
                }],
                "stepsB": []
    ...
    {
        "slug": "close-ss-footer",
        "name": "Close SS Footer",
        "value": {
            "style": {},
            "triggers": [{
                "type": "click",
                "selector": ".ss-signup-footer",
                "preserve3d": true,
                "stepsA": [{
                    "transition": "transform 500ms ease 0",
                    "x": "0px",
